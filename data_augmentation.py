...
def save_flip_image(img_f,flip_lr_img,data_type=1):
    img_dir,f,f_name,path_dir_dir = Analysis_Path(img_f)
    name = f_name + '_flip.jpg'
    if data_type==1:
...
def Data_Augmentation(path,
    ...
    for img_f in pbar:
        ...
        if flip_aug == True:
            ...
            save_flip_image(img_f,flip_lr_img,data_type)
...
if __name__=="__main__":
    ...
    Data_Augmentation(path,
                      ...
                      True, # hsv augment
                      False, # flip augment
                      2, # 0:train/val 1:train 2:val
                      10) # number of labels , remove front and tail labels
