...
def save_blur_img_and_labels(img,img_f,blur_type,blur_size,data_type,blur_name):
    ...
    if blur_type>=1 and blur_type<=4:
        folder_name = 'blur_' + blur_name[blur_type]
...
def get_args():
    ...
    parser.add_argument('-maxnum','--max-num',type=int,help='max number of analysis images',default=40)
    ...
    parser.add_argument('-numhsvclass','--num-hsvclass',type=int,default=20,help='num of hsv class')
    parser.add_argument('-blurtype','--blur-type',type=int,default=3,help='blur type : 0:original; 1:mean; 2:Gaussian; 3:median; 4:bilateral')
    parser.add_argument('-blursize','--blur-size',type=int,default=5,help='filter size of blur')
...
if __name__=="__main__":
    ...
    Data_Augmentation(path,
                      ...
                      True, #do_flip_aug do flip augment
