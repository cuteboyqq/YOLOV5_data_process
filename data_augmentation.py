...
def save_hsv_image_and_label(img_f,num_v,data_type,c,max_num,hsv_images,hsv_folder_name):
...
if __name__=="__main__":
    ...
    Data_Augmentation(path,
                      ...
                      200000, #max num
                      True, # do hsv augment
                      "aug_hsv", #hsv aug save folder name
                      True, # do flip augment
                      1, #flip type --> 0:lr+ud, 1:lr, 2:ud
                      "aug_flip", # flip aug save folder name
    
                      0, # data type --> 0:train/val 1:train 2:val
                      18) # number of hsv aug labels , remove front and tail labels
