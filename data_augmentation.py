...
def save_hsv_image_and_label(img_f,num_v,data_type,c,max_num,hsv_images,hsv_folder_name='aug_flip'):
...
def Data_Augmentation(path,
    ...
    for img_f in pbar:
        ...
        if hsv_aug == True:
            ...
            save_complete = save_hsv_image_and_label(img_f,num_v,data_type,c,max_num,hsv_images,hsv_folder_name)
            c+=1
...
def get_args():
    ...
    parser.add_argument('-imgdir','--img-dir',help='image dir',default='/home/ali/datasets/NewYork_data/NewYork/images')
    ...
    parser.add_argument('-numhsvclass','--num-hsvclass',type=int,default=10,help='num of hsv class')
    
    return parser.parse_args()    

if __name__=="__main__":
    path =  "/home/ali/datasets/NewYork_data/NewYork/images"
    img_size = 320
    ...
    Data_Augmentation(path,
                      ...
                      max_num, #max num
                      do_hsv_aug, # do hsv augment
                      hsv_folder_name, #hsv aug save folder name
                      do_flip_aug, # do flip augment
