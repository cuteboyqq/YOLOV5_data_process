...
def Analysis_label_txt_path(label_txt_path):
    txt_file = label_txt_path.split("\\")[-1] #windows use "\\" linux use "/"
...
def Filter_coco_class(train_label_dir,
    ...
    save_count = 0
    save_new_train_label_dir = r'D:\datasets-old\coco\labels\train7clsNOTS'
        ...
        with open(label_txt_path,'r') as f:
            ...
            if add_new_file:
                ...
                if os.path.exists(train_image_path):
                    ...
                    save_count+=1
                    str_txt = str(save_count)+" save image :"+img_file
                    print("\r",str_txt,end="",flush=True)
...
if __name__=="__main__":
    ...
    if FILTER_LABEL==True:
        train_label_dir = r'D:\datasets-old\coco\labels\train2017'
        save_new_train_label_dir = r'D:\datasets-old\coco\labels\train2017_7class_NOTS'
        train_image_dir = r'D:\datasets-old\coco\images\train2017'
        save_new_train_image_dir = r'D:\datasets-old\coco\images\train2017_7class_NOTS'
