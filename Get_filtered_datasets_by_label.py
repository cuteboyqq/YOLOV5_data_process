...
if __name__=="__main__":
    ...
    #img_dir = r"/home/ali/datasets/train_video/day_labeled-20220311/images"
    #label_list = [8,10,12,13,14,15,17,18]
    #WPI datasets filter R,G,OFF,Yellow
    #label_list = [0,1,2,3,5,7,10,11,12,13,14,15,16]
    #save_dir = r"/home/ali/datasets/LISA_Youtube_COCO_BSTLD_NoCopy_11/include_direction_TLs"
    #for_labelImg = True
